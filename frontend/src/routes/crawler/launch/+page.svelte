<script>
    // [SRS-29] #3: Input fields including Target URL, Crawl Depth, etc.
    ...
    async function startCrawler() {
      // Start button disables on submission (visual feedback via spinner)
      isLoading = true;
...
<style>
  /* [SRS-29.0.5] Sidebar assumed to be in layout, main-content respects sidebar width */
  .main-content {
  ...
  /* SRS-29: Responsive layout for mobile devices */
</style>

<!-- SRS-29 #1: Section title labeled as “Crawler” -->
<div class="main-content">
  <div class="ToolName">
    <h2>Crawler</h2>
    <!-- SRS-29 #2: Optional subtext “Configuration” can be added here -->
  </div>

  <!-- SRS-29 #3: Form includes all required labeled input fields -->
  <form on:submit|preventDefault={startCrawler} class="crawler-form">
    
    <!-- SRS-29.1, 29.3, 29.4: Target URL validation, errors, and user feedback -->
    <div>
    ...
    <!-- SRS-29.5: Positive real values enforced via min="1" -->
    <div>
    ...
    <!-- SRS-29.2: Tooltip/hover text can be added with title="" -->
    <div>
    ...
    <!-- SRS-29 #4: Start button with spinner progress bar -->
